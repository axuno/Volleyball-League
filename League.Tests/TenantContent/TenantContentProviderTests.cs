...
public class TenantContentProviderTests
{
    ...
    public void SetUp()
    {
        _mockWebHostEnvironment = new();
        _mockLogger = new();
        _mockTenantStore = new(Mock.Of<IConfiguration>(), Mock.Of<ILoggerFactory>());
    ...
    public async Task GetContentItems_ShouldReturnContentItems()
    {
        ...
        // Act
        await _tenantContentProvider.SaveContentItem(tenantContext.Object, new() {Topic = "test-topic" }, "<html></html>");
