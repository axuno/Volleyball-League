...
namespace TournamentManager.DAL.DatabaseSpecific
{
	...
	internal partial class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		{
			this.AddElementMapping("TournamentEntity", @"TestOrg", @"dbo", "Tournament", 8, 0);
			...
			this.AddElementFieldMapping("TournamentEntity", "NextTournamentId", "NextTournamentId", true, "BigInt", 0, 19, 0, false, "", null, typeof(System.Int64), 5);
			this.AddElementFieldMapping("TournamentEntity", "CreatedOn", "CreatedOn", false, "DateTime", 0, 0, 0, false, "", null, typeof(System.DateTime), 6);
			this.AddElementFieldMapping("TournamentEntity", "ModifiedOn", "ModifiedOn", false, "DateTime", 0, 0, 0, false, "", null, typeof(System.DateTime), 7);
		}
