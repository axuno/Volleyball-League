...
{
	/// <summary>Class which represents a row in the typed view 'RoundTeam'.</summary>
	/// <remarks>This class is a result class for a query, which is produced with the property <see cref="TournamentManager.DAL.FactoryClasses.QueryFactory.RoundTeam"/>. </remarks>
	[Serializable]
	public partial class RoundTeamRow 
	{
		partial void OnCreated();
		
		/// <summary>Initializes a new instance of the <see cref="RoundTeamRow"/> class.</summary>
		public RoundTeamRow()
		{
			OnCreated();
		}
