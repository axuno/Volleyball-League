...
internal class IdealRoundRobinSystem<TP> : IRoundRobinSystem<TP> where TP : struct, IEquatable<TP>
{
    ...
    */
    ...
    /*
       round01		01-07	03-11	05-09	08-06	10-04	12-02
       round02		02-10	04-08	06-05	07-12	09-03	11-01
       round03		01-09	03-06	05-04	08-02	10-12	11-07
       round04		02-05	04-03	06-01	07-10	09-11	12-08
       round05		01-04	03-02	05-12	08-10	09-07	11-06
       round06		02-01	04-11	06-09	07-08	10-05	12-03
       round07		01-12	03-10	05-08	07-06	09-04	11-02
       round08		02-09	04-06	05-07	08-03	10-01	12-11
       round09		01-08	03-05	06-02	07-04	09-12	11-10
       round10		02-04	03-07	05-01	08-11	10-09	12-06
       round11		01-03	04-12	06-10	07-02	09-08	11-05   
    */
    ...
    */
    ...
    private List<(int Turn, TP Home, TP Guest)> ToGenericList(List<(int Turn, int Home, int Guest)> idealMatches)
    {
        ...
        foreach (var idealMatch in idealMatches)
        {
            ...
            var (turn, home, guest) = (idealMatch.Turn, participants[idealMatch.Home - 1], participants[idealMatch.Guest - 1]);
