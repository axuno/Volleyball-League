...
public class SetsValidatorTests
{
    ...
    {
        var sv = new SetsValidator([], (new TenantContext(), (new(1), new(1))), MatchValidationMode.Default);

        var enums = Enum.GetNames<SetsValidator.FactId>().ToList();
    ...
    public async Task Min_And_Max_Number_Of_Sets(int numOfSets, bool shouldSucceed)
    {
        ...
        var sv = new SetsValidator(sets, (new TenantContext(), (new() {BestOf = false, NumOfSets = 3}, new())), MatchValidationMode.Default);
    ...
    public async Task Min_And_Max_Number_Of_Sets_BestOf(int numOfSets, bool shouldSucceed)
    {
        ...
        var sv = new SetsValidator(sets, (new TenantContext(), (new() { BestOf = true, NumOfSets = 3 }, new())), MatchValidationMode.Default);
    ...
    public async Task BestOf_Required_TieBreak_Played()
    {
        ...
        var sv = new SetsValidator(sets, (new TenantContext(), (matchRule, new())), MatchValidationMode.Default);
    ...
    {
        var sv = new SetsValidator([], (new TenantContext(), (new(), new())), MatchValidationMode.Default);
